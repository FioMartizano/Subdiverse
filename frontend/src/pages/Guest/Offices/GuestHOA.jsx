...
function GuestHOA() {
       ...
       // Track the active hovered tile ID (null means no tile is hovered)
    ...
    return (
       ...
       <section className="bg-white w-full py-16 px-6 md:px-24 flex justify-center rounded-t-[40px] shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.05)] relative z-20 -mt-8">
            <div className="max-w-6xl w-full">
                ...
                {/* Section Header with Green Left Border Accent */}
                ...
                {/* Main Layout Grid split into Grid Gallery (Left) and Text Description (Right) */}
